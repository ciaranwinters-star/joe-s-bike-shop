    ...
    <>
      <section style={{ background: "#1A3A5C" }} className="text-white py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/contact" className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-gray-900 transition">
              Get a Quote
            </a>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12" style={{ color: "#1A3A5C" }}>Our Services</h2>
      ...
      <section className="py-16 px-4" style={{ background: "#FFFFFF" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6" style={{ color: "#1A3A5C" }}>About Us</h2>
      ...
      <section className="py-16 px-4 bg-white">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <p className="text-gray-700 italic mb-3">""</p>
          <p className="font-semibold text-sm" style={{ color: "#E87722" }}>— Happy Customer</p>
        </div>
        <div className="bg-white rounded-xl shadow p-6">
          <p className="text-gray-700 italic mb-3">""</p>
          <p className="font-semibold text-sm" style={{ color: "#E87722" }}>— Happy Customer</p>
